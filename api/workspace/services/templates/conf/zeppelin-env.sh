...
export ZEPPELIN_INTERPRETER_LIFECYCLEMANAGER_CLASS=org.apache.zeppelin.interpreter.lifecycle.TimeoutLifecycleManager
export ZEPPELIN_INTERPRETER_LIFECYCLEMANAGER_TIMEOUT_CHECKINTERVAL=600000
export ZEPPELIN_INTERPRETER_LIFECYCLEMANAGER_TIMEOUT_THRESHOLD={inactivityTimeout}
export ZEPPELIN_ALLOWED_ORIGINS=http://localhost:3000